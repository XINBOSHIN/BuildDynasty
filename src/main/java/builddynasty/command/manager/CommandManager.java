...
package BuildDynasty.command.manager;
...
import BuildDynasty.api.command.exception.CommandUnhandledException;
import BuildDynasty.api.command.exception.ICommandException;
...
import BuildDynasty.command.defaults.DefaultCommands;
...
public class CommandManager implements ICommandManager {
    ...
    public CommandManager(BuildDynasty BuildDynasty) {
        this.BuildDynasty = BuildDynasty;
        DefaultCommands.createAll(BuildDynasty).forEach(this.registry::register);
    }

    @Override
    public IBuildDynasty getBuildDynasty() {
        return this.BuildDynasty;
    }
