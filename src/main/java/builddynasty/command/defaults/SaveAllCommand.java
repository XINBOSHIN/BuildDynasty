...
public class SaveAllCommand extends Command {
    ...
    public SaveAllCommand(IBuildDynasty BuildDynasty) {
        super(BuildDynasty, "saveall");
    }
    ...
    public String getShortDesc() {
        return "Saves BuildDynasty's cache for this world";
    }

    @Override
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The saveall command saves BuildDynasty's world cache.",
                "",
                "Usage:",
                "> saveall"
        );
