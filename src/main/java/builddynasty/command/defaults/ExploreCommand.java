...
import BuildDynasty.api.command.datatypes.RelativeGoalXZ;
...
public class ExploreCommand extends Command {
    ...
    public ExploreCommand(IBuildDynasty BuildDynasty) {
        super(BuildDynasty, "explore");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        BuildDynasty.getExploreProcess().explore(goal.getX(), goal.getZ());
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "Tell BuildDynasty to explore randomly. If you used explorefilter before this, it will be applied.",
                "",
                "Usage:",
