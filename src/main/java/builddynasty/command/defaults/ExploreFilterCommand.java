...
public class ExploreFilterCommand extends Command {
    ...
    public ExploreFilterCommand(IBuildDynasty BuildDynasty) {
        super(BuildDynasty, "explorefilter");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        try {
            BuildDynasty.getExploreProcess().applyJsonFilter(file.toPath().toAbsolutePath(), invert);
