...
public class ReloadAllCommand extends Command {
    ...
    public ReloadAllCommand(IBuildDynasty BuildDynasty) {
        super(BuildDynasty, "reloadall");
    }
    ...
    public String getShortDesc() {
        return "Reloads BuildDynasty's cache for this world";
    }

    @Override
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The reloadall command reloads BuildDynasty's world cache.",
                "",
                "Usage:",
                "> reloadall"
        );
