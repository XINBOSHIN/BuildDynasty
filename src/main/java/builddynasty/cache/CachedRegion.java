...
import BuildDynasty.api.cache.ICachedRegion;
import BuildDynasty.api.utils.BlockUtils;
...
public final class CachedRegion implements ICachedRegion {
    ...
    /**
     * Magic value to detect invalid cache files, or incompatible cache files saved in an old version of BuildDynasty
     */
    ...
    public synchronized final void removeExpired() {
        long expiry = BuildDynasty.settings().cachedChunksExpirySeconds.value;
        if (expiry < 0) {
            return;
        }
