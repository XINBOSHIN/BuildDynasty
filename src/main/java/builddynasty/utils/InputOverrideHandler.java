...
public final class InputOverrideHandler extends Behavior implements IInputOverrideHandler {
    ...
    public InputOverrideHandler(BuildDynasty BuildDynasty) {
        super(BuildDynasty);
        this.blockBreakHelper = new BlockBreakHelper(BuildDynasty.getPlayerContext());
        this.blockPlaceHelper = new BlockPlaceHelper(BuildDynasty.getPlayerContext());
    }
    ...
    private boolean inControl() {
        ...
        return BuildDynasty.getPathingBehavior().isPathing() || BuildDynasty != BuildDynastyAPI.getProvider().getPrimaryBuildDynasty();
    }
