...
public final class PathRenderer implements IRenderer {
    ...
    public static void render(RenderEvent event, PathingBehavior behavior) {
        ...
        final int currentRenderViewDimension = BuildDynastyAPI.getProvider().getPrimaryBuildDynasty().getPlayerContext().world().provider.getDimensionType().getId();
    ...
    public static void drawManySelectionBoxes(Entity player, Collection<BlockPos> positions, Color color) {
        ...
        BlockStateInterface bsi = new BlockStateInterface(BuildDynastyAPI.getProvider().getPrimaryBuildDynasty().getPlayerContext()); // TODO this assumes same dimension between primary BuildDynasty and render view? is this safe?
