...
import BuildDynasty.utils.pathing.MutableMoveResult;
...
public enum Moves {
    DOWNWARD(0, -1, 0) {
        ...
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            return new MovementDownward(context.getBuildDynasty(), src, src.down());
        }
    ...
    PILLAR(0, +1, 0) {
        @Override
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            return new MovementPillar(context.getBuildDynasty(), src, src.up());
        }
    ...
    TRAVERSE_NORTH(0, 0, -1) {
        @Override
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            return new MovementTraverse(context.getBuildDynasty(), src, src.north());
        }
    ...
    TRAVERSE_SOUTH(0, 0, +1) {
        @Override
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            return new MovementTraverse(context.getBuildDynasty(), src, src.south());
        }
    ...
    TRAVERSE_EAST(+1, 0, 0) {
        @Override
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            return new MovementTraverse(context.getBuildDynasty(), src, src.east());
        }
    ...
    TRAVERSE_WEST(-1, 0, 0) {
        @Override
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            return new MovementTraverse(context.getBuildDynasty(), src, src.west());
        }
    ...
    ASCEND_NORTH(0, +1, -1) {
        @Override
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            return new MovementAscend(context.getBuildDynasty(), src, new BetterBlockPos(src.x, src.y + 1, src.z - 1));
        }
    ...
    ASCEND_EAST(+1, +1, 0) {
        @Override
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            return new MovementAscend(context.getBuildDynasty(), src, new BetterBlockPos(src.x + 1, src.y + 1, src.z));
        }
    ...
    DESCEND_EAST(+1, -1, 0, false, true) {
        ...
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            ...
            if (res.y == src.y - 1) {
                return new MovementDescend(context.getBuildDynasty(), src, new BetterBlockPos(res.x, res.y, res.z));
            } else {
                return new MovementFall(context.getBuildDynasty(), src, new BetterBlockPos(res.x, res.y, res.z));
            }
        }
    ...
    DIAGONAL_NORTHEAST(+1, 0, -1, false, true) {
        ...
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            MutableMoveResult res = new MutableMoveResult();
            apply(context, src.x, src.y, src.z, res);
            return new MovementDiagonal(context.getBuildDynasty(), src, EnumFacing.NORTH, EnumFacing.EAST, res.y - src.y);
        }
    ...
    DIAGONAL_NORTHWEST(-1, 0, -1, false, true) {
        ...
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            MutableMoveResult res = new MutableMoveResult();
            apply(context, src.x, src.y, src.z, res);
            return new MovementDiagonal(context.getBuildDynasty(), src, EnumFacing.NORTH, EnumFacing.WEST, res.y - src.y);
        }
    ...
    DIAGONAL_SOUTHEAST(+1, 0, +1, false, true) {
        ...
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            MutableMoveResult res = new MutableMoveResult();
            apply(context, src.x, src.y, src.z, res);
            return new MovementDiagonal(context.getBuildDynasty(), src, EnumFacing.SOUTH, EnumFacing.EAST, res.y - src.y);
        }
    ...
    DIAGONAL_SOUTHWEST(-1, 0, +1, false, true) {
        ...
        public Movement apply0(CalculationContext context, BetterBlockPos src) {
            MutableMoveResult res = new MutableMoveResult();
            apply(context, src.x, src.y, src.z, res);
            return new MovementDiagonal(context.getBuildDynasty(), src, EnumFacing.SOUTH, EnumFacing.WEST, res.y - src.y);
        }
