...
public class MovementFall extends Movement {
    ...
    public MovementFall(IBuildDynasty BuildDynasty, BetterBlockPos src, BetterBlockPos dest) {
        super(BuildDynasty, src, dest, MovementFall.buildPositionsToBreak(src, dest));
    }
