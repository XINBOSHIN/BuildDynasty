...
public class MovementDiagonal extends Movement {
    ...
    public MovementDiagonal(IBuildDynasty BuildDynasty, BetterBlockPos start, EnumFacing dir1, EnumFacing dir2, int dy) {
        this(BuildDynasty, start, start.offset(dir1), start.offset(dir2), dir2, dy);
        // super(start, start.offset(dir1).offset(dir2), new BlockPos[]{start.offset(dir1), start.offset(dir1).up(), start.offset(dir2), start.offset(dir2).up(), start.offset(dir1).offset(dir2), start.offset(dir1).offset(dir2).up()}, new BlockPos[]{start.offset(dir1).offset(dir2).down()});
    }

    private MovementDiagonal(IBuildDynasty BuildDynasty, BetterBlockPos start, BetterBlockPos dir1, BetterBlockPos dir2, EnumFacing drr2, int dy) {
        this(BuildDynasty, start, dir1.offset(drr2).up(dy), dir1, dir2);
    }

    private MovementDiagonal(IBuildDynasty BuildDynasty, BetterBlockPos start, BetterBlockPos end, BetterBlockPos dir1, BetterBlockPos dir2) {
        super(BuildDynasty, start, end, new BetterBlockPos[]{dir1, dir1.up(), dir2, dir2.up(), end, end.up()});
    }
    ...
    private boolean sprint() {
        if (MovementHelper.isLiquid(ctx, ctx.playerFeet()) && !BuildDynasty.settings().sprintInWater.value) {
            return false;
        }
        for (int i = 0; i < 4; i++) {
