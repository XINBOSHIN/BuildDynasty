...
public class MovementDescend extends Movement {
    ...
    public MovementDescend(IBuildDynasty BuildDynasty, BetterBlockPos start, BetterBlockPos end) {
        super(BuildDynasty, start, end, new BetterBlockPos[]{end.up(2), end.up(), end}, end.down());
    }
