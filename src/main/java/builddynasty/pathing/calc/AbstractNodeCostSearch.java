...
public abstract class AbstractNodeCostSearch implements IPathFinder, Helper {
    ...
    /**
     * @see <a href="https://github.com/cabaletta/BuildDynasty/issues/107">Issue #107</a>
     */
    ...
    AbstractNodeCostSearch(int startX, int startY, int startZ, Goal goal, CalculationContext context) {
        ...
        this.map = new Long2ObjectOpenHashMap<>(BuildDynasty.settings().pathingMapDefaultSize.value, BuildDynasty.settings().pathingMapLoadFactor.value);
    }
