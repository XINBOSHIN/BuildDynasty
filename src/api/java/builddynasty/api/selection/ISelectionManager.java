...
package BuildDynasty.api.selection;

import BuildDynasty.api.utils.BetterBlockPos;
import net.minecraft.util.EnumFacing;

/**
 * The selection manager handles setting BuildDynasty's selections. You can set the selection here, as well as retrieving
