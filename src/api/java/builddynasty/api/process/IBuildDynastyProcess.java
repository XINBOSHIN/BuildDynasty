...
import BuildDynasty.api.event.events.PathEvent;

/**
 * A process that can control the PathingBehavior.
 * <p>
 * Differences between a BuildDynasty process and a behavior:
 * <ul>
 * <li>Only one BuildDynasty process can be active at a time</li>
 ...
 * @author leijurv
 */
public interface IBuildDynastyProcess {
    ...
    /**
     * Called when this process is in control of pathing; Returns what BuildDynasty should do.
     *
