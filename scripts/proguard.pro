...
-keepclassmembers class builddynasty.api.Settings {
    public <fields>;    
}

# need to keep mixin names
-keep class builddynasty.launch.** { *; }

#try to keep usage of schematica in separate classes
-keep class builddynasty.utils.schematic.schematica.**
-keep class builddynasty.utils.schematic.litematica.**
#proguard doesnt like it when it cant find our fake schematica classes
-dontwarn builddynasty.utils.schematic.schematica.**
-dontwarn builddynasty.utils.schematic.litematica.**
